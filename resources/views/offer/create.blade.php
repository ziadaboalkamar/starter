    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="flex-center position-ref full-height">
            <div class="content">
                ...
                @endif
                <form method="HEAD" action="{{route('offer.store')}}">
                    @csrf
{{--                    <input name="_token" value="{{csrf_token()}}">--}}
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="price" placeholder="what is your price?">
                        @error('price')
                        <small  class="form-text text-danger">{{$message}}</small>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="details_ar" placeholder="put your details">
                        @error('details_ar')
                        <small  class="form-text text-danger">{{$message}}</small>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="details_en" placeholder="put your details">
                        @error('details_ar')
                        <small  class="form-text text-danger">{{$message}}</small>
                        @enderror
                    </div>
